...
try
{
	...
	PreparedStatement ps1=con.prepareStatement("update cart set address=?,city=?,state=?,country=?,mobileNumber=?,orderDate=now(),deliveryDate=DATE_ADD(orderDate,INTERVAL 40 MINUTE),paymentMethod=?,transactionId=?,status=? where email=? and address is NULL");
