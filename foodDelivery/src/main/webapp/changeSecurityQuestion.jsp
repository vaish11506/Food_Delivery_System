...
<h3>Select Your New Security Question</h3>
  <select class="input-style" name="securityQuestion">
        ...
        <option value="What is the name of your favorate pet animal?">What is the name of your favorite pet animal?</option>
...
<input class="input-style" type="password" name="passwoord" placeholder="Enter Password(For Security)" required>
<hr>
